    ...
    <div className="fixed right-0 top-1/2 -translate-y-1/2 z-50 flex items-center group">
      ...
      >
        ...
        <svg 
          ...
          width="32" 
          height="32" 
          className="fill-current w-8 h-8 md:w-10 md:h-10 relative z-10 drop-shadow-md"
        >
        ...
        <span className="text-[10px] md:text-xs font-bold uppercase tracking-wider relative z-10 md:hidden mt-1 text-center leading-tight">
          Book<br/>Direct
        </span>
      </Link>
    </div>
